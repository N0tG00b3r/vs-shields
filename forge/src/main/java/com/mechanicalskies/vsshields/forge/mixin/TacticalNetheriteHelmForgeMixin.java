...
@Mixin(TacticalNetheriteHelm.class)
public class TacticalNetheriteHelmForgeMixin {
        ...
        consumer.accept(new IClientItemExtensions() {
            ...
            public HumanoidModel<?> getHumanoidArmorModel(LivingEntity entityLiving, ItemStack itemStack,
                ...
                if (armorSlot == EquipmentSlot.HEAD) {
                    if (TacticalNetheriteHelm.getModelSupplier() != null) {
                        return TacticalNetheriteHelm.getModelSupplier().get();
                    }
                }
                return _default;
            }
