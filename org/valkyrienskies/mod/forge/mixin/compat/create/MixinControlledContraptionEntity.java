...
public abstract class MixinControlledContraptionEntity extends AbstractContraptionEntity {
    ...
    private void redirectPutMotion(MovementContext instance, Vec3 value) {
        ...
        double scalar = Math.abs(angleDelta / 360.0) * Math.signum(dir.m_123341_() + dir.m_123342_() + dir.m_123343_());

        instance.motion = new Vec3(Math.abs(dir.m_123341_()), Math.abs(dir.m_123342_()), Math.abs(dir.m_123343_())).m_82490_(scalar);
    }
    //Region end
}
