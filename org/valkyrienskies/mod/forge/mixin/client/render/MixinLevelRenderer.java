...
public class MixinLevelRenderer {
    ...
    private void renderBlockDamage(final BlockRenderDispatcher blockRenderManager, final BlockState state,
        ...
        if (ship != null) {
            ...
            final Vec3 cameraPos = methodCamera.m_90583_();

            transformRenderWithShip(renderTransform, matrixStack, blockPos, cameraPos.f_82479_, cameraPos.f_82480_, cameraPos.f_82481_);

            final Matrix3f newNormalMatrix = new Matrix3f(matrixStack.m_85850_().m_252943_());
            final Matrix4f newModelMatrix = new Matrix4f(matrixStack.m_85850_().m_252922_());
