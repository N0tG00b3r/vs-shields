...
public abstract class MixinVibrationSystem {
    ...
    private void scheduleVibration(
        ...
        original.call(level, data, gameEvent, context,
            VectorConversionsMCKt.toMinecraft(VSGameUtilsKt.getWorldCoordinates(level, BlockPos.m_274446_(pos), VectorConversionsMCKt.toJOML(pos))),
            VectorConversionsMCKt.toMinecraft(VSGameUtilsKt.getWorldCoordinates(level, BlockPos.m_274446_(sensorPos), VectorConversionsMCKt.toJOML(sensorPos)))
        );
    }
    ...
    private static boolean adjustOcclusionForWorldPosition(Level level, Vec3 pos1, Vec3 pos2, Operation<Boolean> original) {
        ...
        Vec3 pos1InWorld = VectorConversionsMCKt.toMinecraft(VSGameUtilsKt.getWorldCoordinates(level, BlockPos.m_274446_(pos1), VectorConversionsMCKt.toJOML(pos1)));
        Vec3 pos2InWorld = VectorConversionsMCKt.toMinecraft(VSGameUtilsKt.getWorldCoordinates(level, BlockPos.m_274446_(pos2), VectorConversionsMCKt.toJOML(pos2)));
