...
public class MixinLocateHiveGoal {
    ...
    private Stream<BlockPos> onComparingDouble(Stream<BlockPos> instance, Comparator<BlockPos> comparator,
        ...
        return original.call(instance, Comparator.comparingDouble( pos -> BlockPos.m_274446_(VSGameUtilsKt.toWorldCoordinates(this.field_20375.m_9236_(), (BlockPos) pos)).m_123331_(blockPos)));
    }
}
