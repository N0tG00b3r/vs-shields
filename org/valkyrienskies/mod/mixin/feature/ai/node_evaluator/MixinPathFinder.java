...
public class MixinPathFinder {
    ...
    Mob mob) {
        return original.call(instance, Collectors.<BlockPos, Target, BlockPos>toMap(blockPos ->  {
            BlockPos transformedPos = BlockPos.m_274446_(VSGameUtilsKt.toWorldCoordinates(mob.m_9236_(), blockPos));
            return this.nodeEvaluator.m_7568_(transformedPos.m_123341_(), transformedPos.m_123342_(), transformedPos.m_123343_());
