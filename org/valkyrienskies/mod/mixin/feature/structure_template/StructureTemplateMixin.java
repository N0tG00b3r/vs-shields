...
public abstract class StructureTemplateMixin implements StructureTemplateFillFromVoxelSet {
    ...
    public void vs$fillFromVoxelSet(@NotNull Level level, @NotNull Iterable<BlockPos> voxels,
        ...
        for (BlockPos currentWorldPos : voxels) {
            BlockPos relativePos = currentWorldPos.m_121996_(min);
            BlockState blockState = level.m_8055_(currentWorldPos);

            BlockEntity blockEntity = level.m_7702_(currentWorldPos);
            ...
            if (customTag != null) {
                ...
                blockInfo = new StructureTemplate.StructureBlockInfo(relativePos, blockState, blockEntity.m_187481_());
            } else {
        ...
        this.size = new Vec3i(
            max.m_123341_() - min.m_123341_() + 1,
            max.m_123342_() - min.m_123342_() + 1,
