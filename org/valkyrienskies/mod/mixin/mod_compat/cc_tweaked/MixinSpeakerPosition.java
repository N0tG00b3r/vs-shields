...
public abstract class MixinSpeakerPosition {
    ...
    public double withinDistance$distanceToSqr(final Vec3 position, final Vec3 other) {
        ...
        if (ship != null) {
            return VSGameUtilsKt.squaredDistanceBetweenInclShips(this.level(), position.f_82479_, position.f_82480_, position.f_82481_, other.f_82479_, other.f_82480_, other.f_82481_);
        }
        return position.m_82557_(other);
    }
}
