...
public class MixinTrackBlockItem {
    ...
    private BlockState wrapPlacementState(UseOnContext context, Operation<BlockState> original){
        if(context != null && context.m_43723_() != null) {
            PlayerUtil.transformPlayerTemporarily(context.m_43723_(), context.m_43725_(), context.m_8083_());
            BlockState state = original.call(context);
            PlayerUtil.untransformPlayer(context.m_43723_());
            return state;
