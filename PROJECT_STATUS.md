...
2. **Остаточный аутлайн от анализатора** — при использовании Ship Analyzer игрок иногда продолжает подсвечиваться собственным сканером (residual glowing effect), несмотря на попытки отфильтровать себя из списка целей. Требуется дальнейшее расследование.
